        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12 col-lg-6 pt-2 pb-4 pt-4 text-center d-flex flex-column align-items-center justify-content-center">
                    <input type="text" placeholder="Texto" class="form-control smaller-transparent-input bg-custom-color">
                    <div>
                        <input type="text" placeholder="Titulo" class="form-control mt-2 bg-custom-color">
                    </div>
                    ...
                    <a href="https://www.google.com/maps/place/Café+Cafetzal/@19.6293735,-99.0314331,15z/data=!4m5!3m4!1s0x0:0x8c8516da97cae053!8m2!3d19.6293735!4d-99.0314331?hl=es-419"
                    class="btn btn-outline-light mt-4">Mas informacion</a>
                </div>
                <div class="col-12 col-lg-6 p-0">
                    <img src="https://www.gastrolabweb.com/u/fotografias/m/2021/5/17/f608x342-13334_43057_0.jpg" alt="location">
                </div>
            </div>
        </div>
    </footer>
